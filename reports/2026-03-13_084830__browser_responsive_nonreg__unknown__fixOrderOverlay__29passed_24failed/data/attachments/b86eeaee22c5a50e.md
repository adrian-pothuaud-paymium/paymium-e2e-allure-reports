          ...
          - generic [ref=e57]:
            ...
            - list [ref=e119]:
              ...
              - listitem [ref=e141] [cursor=pointer]:
                ...
                - generic [ref=e156]:
                  - generic [ref=e158]: 1 837,81 €
                  - generic [ref=e162]:
                    - img [ref=e164]
                    - generic [ref=e166]: 1,89 %
              - separator [ref=e167]
      ...
      - generic [ref=e320]:
        ...
        - generic [ref=e330]:
          - generic [ref=e331]:
            ...
            - generic [ref=e332]: 00:18
          - generic [ref=e333]: Êtes-vous toujours avec nous ?
          - button "Oui" [ref=e334] [cursor=pointer]:
            - generic [ref=e335]: Oui
  - generic [ref=e337]:
    - 'dialog "Plateforme de Gestion du Consentement : Personnalisez vos Options" [ref=e338]':
      - generic [ref=e339]:
        - generic [ref=e340]:
          - button "Fermer le widget sans consentement" [ref=e341] [cursor=pointer]:
            - generic [ref=e342]: Continuer sans accepter
          - generic [ref=e344]:
            - heading "Des cookies pour vos bitcoins !" [level=1] [ref=e347]:
              - generic [ref=e348]: Des cookies pour
              - generic [ref=e349]: vos bitcoins !
            - generic [ref=e350]:
              - paragraph [ref=e351]:
                - text: Parce que
                - strong [ref=e352]: stacker des sats ça donne faim
                - text: ", nous vous proposons une pause cookie ! 🍪"
              - paragraph [ref=e353]:
                - text: Avec votre accord, Paymium aimerait utiliser des
                - strong [ref=e354]: cookies
                - text: placés par nous et/ou par nos partenaires sur notre site.
              - paragraph [ref=e355]: Certains de ces cookies sont strictement nécessaires au bon fonctionnement du site et à l'optimisation de ses performances techniques.
              - paragraph [ref=e356]:
                - text: D'autres sont utilisés pour mesurer l'impact de nos campagnes publicitaires.
                - strong [ref=e357]: Vous choisissez ceux qui vous plaisent
                - text: ", comme pour le trading !"
              - paragraph [ref=e358]: Pour obtenir d'avantages d'information et/ou modifier vos préférences, cliquez sur le bouton "Je choisis".
            - paragraph [ref=e360]: Pour modifier vos préférences par la suite, cliquez sur le lien 'Préférences de cookies' situé dans le pied de page.
          - button "Consentements certifiés par Axeptio" [ref=e363]:
            - generic [ref=e364]: Consentements certifiés par
            - img "Axeptio" [ref=e368]
        - generic [ref=e372]:
          - button "Je choisis les cookies à configurer" [ref=e373] [cursor=pointer]: Je choisis
          - button "Accepter les cookies" [ref=e374] [cursor=pointer]: OK pour moi
      - generic [ref=e375]:
        - text: Axeptio consent
        - checkbox [ref=e376]
      - generic [ref=e377]:
        - paragraph [ref=e378]: "Plateforme de Gestion du Consentement : Personnalisez vos Options"
        - paragraph [ref=e379]: Notre plateforme vous permet d'adapter et de gérer vos paramètres de confidentialité, en garantissant la conformité avec les réglementations. Personnalisez vos préférences pour contrôler la manière dont vos informations sont manipulées.
    - button "Fermer le widget sans consentement" [ref=e380] [cursor=pointer]:
      - img [ref=e384]
```